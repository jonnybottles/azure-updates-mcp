...
python -m azure_updates_mcp.server   # Run server (stdio transport)
...
MCP server using FastMCP v2 with stdio transport. Fetches Azure Updates from Microsoft's RSS feed.
